...
DISTRO_IMAGES[focal]=https://cloud-images.ubuntu.com/focal/current/focal-server-cloudimg-amd64.img
...
DISTRO_CHECKSUMS[focal]=https://cloud-images.ubuntu.com/focal/current/SHA256SUMS
...
# my virt-install cannot go above ubuntu18.10 :( (ubuntu 18.04)
DISTRO_OSVARIANT[focal]=auto
